...
import com.iesvdc.entidades.Alumnos;
 ...
 */
@javax.ejb.Stateless
@Path("com.iesvdc.entidades.alumnos")
public class AlumnosFacadeREST extends AbstractFacade<Alumnos> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Alumnos entity) {
        super.edit(entity);
    }
    ...
    public Alumnos find(@PathParam("id") String id) {
